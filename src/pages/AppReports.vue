<template>
      ...
      <div class="nk-block-head">
        <div class="nk-block-between">
          <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">AI Reports</h3>
                  ...
                  <div class="card-inner p-0">
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                      <div class="nk-tb-item nk-tb-head">
                        ...
                        <div class="nk-tb-col tb-col-md">
                          <span class="sub-text">Booking Made By "Location"</span>
                        </div>
                        <div class="nk-tb-col tb-col-xxl">
                          <span class="sub-text">Meeting Destination</span>
                        </div>
                        <div class="nk-tb-col tb-col-lg">
                          <span class="sub-text">View Report</span>
                        </div>
                        <div class="nk-tb-col tb-col-lg">
  ...
  <script>
    ...
    import { getAppointmentList } from '@/apis/appointapi';
